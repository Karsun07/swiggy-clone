    ...
    return (
        <div className="flex justify-between py-6 border-b border-gray-200">
            ...
            <div className="w-[70%] pr-4">
                ...
                <p className="text-gray-500 text-sm mt-2 mb-8 line-clamp-2">
                    {menu?.description}
                </p>
            </div>
            ...
            <div className="w-[30%] flex flex-col items-center relative">
                ...
                {imageUrl && (
                    <img
                        className="w-36 h-28 object-cover rounded-xl shadow-sm"
                        src={imageUrl}
                        alt={menu?.name}
                    />
                )}

                <button className="bg-white text-green-600 border border-gray-300 px-6 py-1 rounded-lg font-semibold absolute bottom-[-10px] shadow-md text-sm">
                    ADD
                </button>
            </div>
